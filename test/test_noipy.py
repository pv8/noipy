...
class PluginsTest(unittest.TestCase):
    ...
    def test_generic_plugin_malformed_url(self):
        ...
        self.assertEqual(
            ...
            'Malformed URL.',
            'Status message should contain "Malformed URL."',
        )
...
class AuthInfoTest(unittest.TestCase):
    ...
    def test_store_from_stdin_input(self):
        cmd_args = ['--store', '--provider', 'noip', '-c', self.test_dir]
...
class GeneralTest(unittest.TestCase):
    ...
    def test_dns_plugin_status_message(self):
        ...
        expected_message = (
            'SUCCESS: IP address (1.1.1.1) is up to date, '
        ...
        expected_message = (
            'ERROR: The hostname specified is not a '
        ...
        expected_message = (
            'ERROR: Too many hosts (more than 20) specified '
