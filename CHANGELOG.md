...
- Automatic deploy to [PyPI](https://pypi.python.org/pypi) via [Travis CI](https://docs.travis-ci.com/user/deployment/pypi/)
- Minor refactor
...
- Changed code coverage service from [Coveralls](https://coveralls.io) to [Codecov](https://codecov.io)
...
- Using the awesome [Requests HTTP library](https://github.com/kennethreitz/requests)
- Using [tox](http://tox.readthedocs.org/en/latest/) in order to ease test against multiple Python versions
...
- Switched to [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0)
...
- Support for [DuckDNS domains update](https://www.duckdns.org/install.jsp)
...
- Support for [DynDNS Update API](http://dyn.com/support/developers/api/)
